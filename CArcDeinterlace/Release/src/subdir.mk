...
src/%.o: ../src/%.cpp
	...
	g++ -std=c++17 -I"/home/streit/Documents/ARC_API/3.6/CArcDeinterlace/inc" -I"/home/streit/Documents/ARC_API/3.6/CArcBase/inc" -O3 -Wall -c -fmessage-length=0 -fPIC -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -o "$@" "$<"
